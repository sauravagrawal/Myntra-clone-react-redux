...
export const postBagData = (payload) => async (dispatch) => {
  ...
  return axios
    .post("https://fakestoreapi.com/carts", 
    {
      userId:10,
      date:Date.now(),
      products:[{productId:payload.id,quantity:1}]
      }
        )
    .then((res) => {
...
export const patchBagData = (clickedId, isQtySame) => async (dispatch) => {
  ...
  return axios
    .patch(`https://fakestoreapi.com/carts/${clickedId}`, {
      quantity: `${isQtySame}`,
    })
    .then((res) => {
...
export const deleteBagData = (idx) => async (dispatch) => {
  ...
  return axios
    .delete(`https://fakestoreapi.com/carts/${idx}`)
    .then((res) => {
...
export const getBagData = (payload) => async(dispatch) => {
  ...
  return axios
    .get("https://fakestoreapi.com/carts/user/10", payload)
    .then((res) => {
